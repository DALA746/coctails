...
const Hero = () => {
  return (
    <div className="flex flex-col sm:flex-row lg:flex-row">
      {/* <div className="bg-hero bg-no-repeat bg-cover h-full sm:w-[100%] lg:w-[50%]"></div> */}
      <div className="bg-palePink  w-full p-12 flex flex-col justify-center items-center">
